...
std::shared_ptr<ParticleSystem> psystem = 0;
// fps
...
{
	//pbfsolver = std::make_shared<pbf::PbfSolverGpu>();
    psystem = std::make_shared<ParticleSystem>(numParticles, gridSize, bUseOpenGL);
    psystem->reset(ParticleSystem::CONFIG_GRID);
	//pbfsolver->ps_adaptor_ = psystem;
	//psystem->Solver = pbfsolver;
    if (bUseOpenGL)
    {
